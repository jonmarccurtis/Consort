...
<?php elseif ( is_category() || x_is_portfolio_category() ) : ?>
  ...
  // CC_MOD simplify Category Header
  ...
  $title    = ( $meta['archive-title']    != '' ) ? $meta['archive-title']    : __( '<strong>' . single_cat_title( '', false ) . '</strong>');
  $subtitle = ( $meta['archive-subtitle'] != '' ) ? $meta['archive-subtitle'] : '';
